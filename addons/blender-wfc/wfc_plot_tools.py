...
#     if not cell.isCollapsed or len(cell.possibleModules) != 1:
#         return []
    
#     module = cell.possibleModules[0]
#     plots = []
...
#             [(0, 0), (module_size, 0), (module_size, module_size), (0, module_size)]
#         ],
#         'ROAD_STRAIGHT': [
...
#             world_pos = Vector((cell.posX * module_size, cell.posY * module_size, 0))
